...
urlpatterns = [
    ...
    url(r'^start_term_prediction/(?P<experiment_id>\w+)/$',views.start_term_prediction,name='start_term_prediction'),
    url(r'^explore_terms/(?P<experiment_id>\w+)/$',views.explore_terms,name = 'explore_terms'),
    url(r'^delete_predictions/(?P<experiment_id>\w+)/$',views.delete_predictions,name = 'delete_predictions'),
